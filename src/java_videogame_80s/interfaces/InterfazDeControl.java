 ...
 * @author juanq
 */
public class InterfazDeControl extends javax.swing.JFrame {

    /**
     * Creates new form MenuJuego
     */
    public InterfazDeControl() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazDeControl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazDeControl().setVisible(true);
            }
        });
    }
